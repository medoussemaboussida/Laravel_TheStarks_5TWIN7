...
@section('title', 'Modifier une Zone Urbaine')

@section('content')
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Modifier une Zone Urbaine</h1>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('nom') is-invalid @enderror"
                                       id="nom" name="nom" value="{{ old('nom', $zone->nom) }}" required>
                                @error('nom')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control @error('surface') is-invalid @enderror"
                                       id="surface" name="surface" value="{{ old('surface', $zone->surface) }}" min="0" step="0.01">
                                @error('surface')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted small">
                        ...
                        Le nom est obligatoire. La surface peut être laissée vide.
                    </p>
                </div>
            </div>
        </div>
